...
# Carregar os índices ecológicos
df = pd.read_csv("indices_ecologicos_bacterias.tsv", sep="\t", index_col=0)
...
plt.title("Ecological Indices per Bacterial Sample", fontsize=14)

# Legenda combinada
fig.legend(loc="upper right", bbox_to_anchor=(1, 1), bbox_transform=ax1.transAxes)

plt.tight_layout()
plt.savefig("ecological_indices_bacteria_dual_axis.png", dpi=300)
plt.show()
